...
namespace BrickController2.DeviceManagement
{
    internal class BoostDevice : BluetoothDevice
    {
        ...
        public BoostDevice(string name, string address, byte[] deviceData, IDeviceRepository deviceRepository, IUIThreadService uiThreadService, IBluetoothLEService bleService)
