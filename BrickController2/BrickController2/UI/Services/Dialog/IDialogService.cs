...
namespace BrickController2.UI.Services.Dialog
{
    public interface IDialogService
    {
        ...
        Task<ProgressDialogResult> ShowProgressDialogAsync(bool isDeterministic, Func<IProgressDialog, CancellationToken, Task> action, string title = null, string message = null, string cancelButtonText = null);
